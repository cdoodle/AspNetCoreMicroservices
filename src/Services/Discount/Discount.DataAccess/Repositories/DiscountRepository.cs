    ...
    public class DiscountRepository : IDiscountRepository
    {
        ...
        public DiscountRepository(IConfiguration configuration)
        {
            ...
            _connection = new NpgsqlConnection
              (_configuration.GetConnectionString("DiscountConnectionString"));
        }

        public async Task<Coupon> GetDiscountById(int couponId)
        {
            var coupon = await _connection.QueryFirstOrDefaultAsync<Coupon>
                ("SELECT * FROM Coupon WHERE Id = @Id", new { Id = couponId });
